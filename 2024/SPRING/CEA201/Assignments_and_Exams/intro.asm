...
; ллллллллллллллллллллллллллллллллллллллллллллллллллллллллл
  ...
  ; ------------------------------------------------
    ...
    start:                          ; The CODE entry point to the program
        ...
        print chr$("I am Hoang Viet",13,10) ; 13: carriage return, 10: new line  
        print chr$("I'm 20",13,10) ; 13: carriage return, 10: new line
        print chr$("I'm studying CEA and I'm so confused now.",13,10) ; 13: carriage return, 10: new line
