...
********************************************************************************/
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'PE_DBI202_Sp2024')
BEGIN
	ALTER DATABASE PE_DBI202_Sp2024 SET OFFLINE WITH ROLLBACK IMMEDIATE;
	ALTER DATABASE PE_DBI202_Sp2024 SET ONLINE;
	DROP DATABASE PE_DBI202_Sp2024;
END

GO

CREATE DATABASE PE_DBI202_Sp2024
GO

USE PE_DBI202_Sp2024
GO
